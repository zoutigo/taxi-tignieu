...
export function InvoiceEditForm({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      realKm: defaultValues.realKm ?? bookingSummary?.estimatedKm ?? 0,
      estimatedLuggage: defaultValues.estimatedLuggage ?? undefined,
      realLuggage: defaultValues.realLuggage ?? defaultValues.estimatedLuggage ?? 0,
      estimatedPax: defaultValues.estimatedPax ?? undefined,
      realPax: defaultValues.realPax ?? defaultValues.estimatedPax ?? 1,
